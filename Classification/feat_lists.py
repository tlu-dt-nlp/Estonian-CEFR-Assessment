#Feature lists used in the classification experiments

#All linguistic features in the dataset
all_feats = ['compounds', 'A' ,'D', 'I', 'J', 'K', 'N', 'P', 'S', 'S_Prop', 'V', 
    ...
    'FK', 'poly_ratio', 'syll_count', 'spell_word_ratio', 'spell_sent_ratio', 
    'spell_errors_per_sent', 'avg_spell_word_ratio', 'error_word_ratio', 'error_sent_ratio', 
    'errors_per_word', 'errors_per_sent','avg_error_word_ratio']

#All features presumed relevant predictors of proficiency level
...
#All morphological features in the dataset
...
#Morphological features presumed relevant predictors of proficiency level
...
#All lexical features in the dataset
...
#Lexical features presumed relevant predictors of proficiency level
lex_feats_selection = ['lemma_count', 'RTTR', 'MTLD', 'CVV', 'D_TTR', 'S_abstr', 'rare_5000']

#All surface features in the dataset
surf_feats = ['word_count', 'sent_count', 'word_length', 'sent_length', 'LIX', 'SMOG',
    'FK', 'poly_ratio', 'syll_count']

#Surface features presumed relevant predictors of proficiency level
surf_feats_selection = ['word_count', 'sent_count', 'word_length', 'sent_length', 'SMOG',
    'syll_count']

#All error features in the dataset
error_feats = ['spell_word_ratio', 'spell_sent_ratio', 'spell_errors_per_sent', 
    'avg_spell_word_ratio', 'error_word_ratio', 'error_sent_ratio', 'errors_per_word', 
    'errors_per_sent' ,'avg_error_word_ratio']

#Error features presumed relevant predictors of proficiency level
error_feats_selection = ['spell_word_ratio', 'avg_spell_word_ratio', 
